...
module_eval(<<'...end retina_parser.y/module_eval...', 'retina_parser.y', 276)
...
module_eval(<<'.,.,', 'retina_parser.y', 46)
...
module_eval(<<'.,.,', 'retina_parser.y', 52)
...
module_eval(<<'.,.,', 'retina_parser.y', 245)
